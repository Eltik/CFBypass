...
export default class API {
     ...
     */
    public async getHeaders(url: string): Promise<{ "User-Agent": string, "Cookie": string }> {
        return new Promise((resolve, reject) => {
            axios.get(url, {
                ...
                if (this.isCloudflareJSChallenge(err.response.data)) {
                    ...
                    const scriptReq = await axios.get(parsedURL + script, {
                        headers: {
                            "User-Agent": this.userAgent,
                            Referer: formURL
                        }
                    ...
                    const formRequest = await axios.post(formURL, `md=${formValue}`, {
                        headers: {
                            "User-Agent": this.userAgent,
